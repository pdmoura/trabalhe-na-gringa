...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0B1220] font-sans text-slate-200 selection:bg-[#00C853]/30 selection:text-white overflow-hidden">
      ...
      <footer className="py-12 bg-[#071426] border-t border-white/5 text-center">
        <div className="container mx-auto px-6 flex flex-col items-center">
          <div className="flex gap-6 mb-8">
            ...
            <a href="#" className="text-slate-400 hover:text-[#00C853] transition-colors" aria-label="TikTok">
              <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
      ...
      {/* Mobile Sticky CTA */}
      <div className="fixed bottom-0 left-0 right-0 z-50 p-4 bg-[#0B1220]/90 backdrop-blur border-t border-white/10 md:hidden">
        <button 
          onClick={() => handleCheckoutClick('sticky_mobile')}
          className="w-full block text-center py-4 bg-[#00C853] text-[#0B1220] font-bold rounded-xl shadow-lg"
        >
          QUERO ACESSO AGORA
        </button>
      </div>
